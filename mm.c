...
/**
 * Checks if the next adjacent block is a free one. Usefull for coalescing
 */
...
/**
 * Checks if the previous adjacent block is a free one. Usefull for coalescing. NOT USED
 */
